...
export const icons = observeError(async (req: Request, res: Response, next: NextFunction) => {
  ...
  res.status(200).json({ range: "'icons'!A1:Z1000", majorDimension: 'ROWS', values: values });
});

export const products = observeError(async (req: Request, res: Response, next: NextFunction) => {
  const prisma = getDbClient();
  ...
  res.status(200).json({ range: "'products'!A1:Z1000", majorDimension: 'ROWS', values: values });
});

export const productImages = observeError(async (req: Request, res: Response, next: NextFunction) => {
  const prisma = getDbClient();
  ...
  res.status(200).json({ range: "'product-images'!A1:Z1000", majorDimension: 'ROWS', values: values });
});

export const careers = observeError(async (req: Request, res: Response, next: NextFunction) => {
  const prisma = getDbClient();
  ...
  res.status(200).json({ range: "'careers'!A1:Z1000", majorDimension: 'ROWS', values: values });
});

export const careerDetails = observeError(async (req: Request, res: Response, next: NextFunction) => {
  const prisma = getDbClient();
  ...
  res.status(200).json({ range: "'career-details'!A1:Z1000", majorDimension: 'ROWS', values: values });
});

export const certifications = observeError(async (req: Request, res: Response, next: NextFunction) => {
  const prisma = getDbClient();
  ...
  res.status(200).json({ range: "'certifications'!A1:Z1000", majorDimension: 'ROWS', values: values });
});

export const sns = observeError(async (req: Request, res: Response, next: NextFunction) => {
  const prisma = getDbClient();
  ...
  res.status(200).json({ range: "'sns'!A1:Z1000", majorDimension: 'ROWS', values: values });
});

export const articlesMetadata = observeError(async (req: Request, res: Response, next: NextFunction) => {
  const prisma = getDbClient();
...
export const articlesPickup = observeError(async (req: Request, res: Response, next: NextFunction) => {
  const prisma = getDbClient();
...
export const version = observeError(async (req: Request, res: Response, next: NextFunction) => {
  const prisma = getDbClient();
