...
describe('spreadsheets', () => {
  ...
  describe('icons', () => {
    test('レコードの取得に成功し、ジャグ配列として返却されること', async () => {
      ...
      spy_PrismaClient.mockReturnValue({ icons: { findMany: mock_findMany } } as unknown as any);
  ...
  describe('products', () => {
    test('レコードの取得に成功し、ジャグ配列として返却されること', async () => {
      ...
      // モック
      const mock_findMany = jest.fn().mockResolvedValue(dummy_data);
      spy_PrismaClient.mockReturnValue({ products: { findMany: mock_findMany } } as unknown as any);
  ...
  describe('productImages', () => {
    test('レコードの取得に成功し、ジャグ配列として返却されること', async () => {
      ...
      // モック
      const mock_findMany = jest.fn().mockResolvedValue(dummy_data);
      spy_PrismaClient.mockReturnValue({ product_images: { findMany: mock_findMany } } as unknown as any);
  ...
  describe('careers', () => {
    test('レコードの取得に成功し、ジャグ配列として返却されること', async () => {
      ...
      // モック
      const mock_findMany = jest.fn().mockResolvedValue(dummy_data);
      spy_PrismaClient.mockReturnValue({ careers: { findMany: mock_findMany } } as unknown as any);
  ...
  describe('careerDetails', () => {
    test('レコードの取得に成功し、ジャグ配列として返却されること', async () => {
      ...
      // モック
      const mock_findMany = jest.fn().mockResolvedValue(dummy_data);
      spy_PrismaClient.mockReturnValue({ career_details: { findMany: mock_findMany } } as unknown as any);
  ...
  describe('certifications', () => {
    test('レコードの取得に成功し、ジャグ配列として返却されること', async () => {
      ...
      // モック
      const mock_findMany = jest.fn().mockResolvedValue(dummy_data);
      spy_PrismaClient.mockReturnValue({ certifications: { findMany: mock_findMany } } as unknown as any);
  ...
  describe('sns', () => {
    test('レコードの取得に成功し、ジャグ配列として返却されること', async () => {
      ...
      // モック
      const mock_findMany = jest.fn().mockResolvedValue(dummy_data);
      spy_PrismaClient.mockReturnValue({ sns: { findMany: mock_findMany } } as unknown as any);
