...
const App = () => {
  ...
  // NOTE: React.useEffect の実行タイミング
  // useEffect はコンポーネントのレンダリング結果 (return で指定された JSX) が DOM に反映された直後に実行される
  // 関数本体の処理 (例えば `const [x, setX] = React.useState(true);` 等) がすべて実行され、JSX が return された後になる
