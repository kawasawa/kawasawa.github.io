...
import { CareerData, CertificationData, useCareers, useCertifications } from '@/hooks';
import { isProduction, isTest } from '@/utils/env';
import { handleError } from '@/utils/errors';
import { extractAlt } from '@/utils/images';
import { LocaleCodes, Yup } from '@/utils/localization';
...
const ContactArea = (props: { t: TFunction; section: string }) => {
  ...
  const submit = formMethod.handleSubmit(async (data) => {
    try {
      const params = {
        name: data.name,
        email: data.email,
