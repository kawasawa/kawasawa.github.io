...
export const Footer = () => (
  <AppBar component="footer" sx={{ position: 'static', display: 'block', p: 2 }}>
    ...
    <Box sx={{ display: 'flex', justifyContent: 'center', pb: 1 }} data-testid="Footer__ReadMe">
      <Link href={links.readme} target="_blank" color="inherit" underline="hover">
        <Stack direction="row" gap={0.5} sx={{ alignItems: 'center' }}>
          <LaunchIcon sx={{ color: 'grey.400', fontSize: 14 }} />
          <Typography sx={{ color: 'grey.400', fontSize: 14 }}>README</Typography>
        </Stack>
      </Link>
    </Box>
    {/* Copyright */}
