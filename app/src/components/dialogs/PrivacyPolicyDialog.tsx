...
export const PrivacyPolicyDialog = React.forwardRef(function _(
  props: PrivacyPolicyDialogProps,
  ref: React.Ref<PrivacyPolicyDialogRef>
) {
  ...
  // useImperativeHandle でメソッドを公開できる
  //   親コンポーネントは公開されたメソッドを呼び出すことができる
  //   この場合 scrollTop という名前で引数無しの関数が公開され、これを呼び出すと scrollTop() が実行される
